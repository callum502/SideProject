...
function App() {
  ...
  return <div className="app">
    ...
    {home ? <><LocationSearch locations={db.locations} loaded={loaded}/><LocationMap locations={db.locations} selectedId={null} onSelect={id => choose(id)}/></> : <><PageNavigation place={place} boulder={boulder} problem={problem} problemId={problemId}/>
