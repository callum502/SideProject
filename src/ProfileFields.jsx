...
export default function ProfileFields({ user }) {
 ...
 return <><label>Display name *<input name="name" required maxLength={120} autoComplete="nickname" defaultValue={user?.profileComplete === false && user?.name === 'Climber' ? '' : user?.name || ''} placeholder="How you’d like to be known"/></label>
