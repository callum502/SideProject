...
export function ProblemPage({ problem, boulder, edit, remove, busy, Shapes }) {
  ...
  return <article className="problem-page"><div className="boulder-heading"><div><div className="eyebrow">PROBLEM</div><h1>{problem.name}</h1><span className="grade">{problem.grade}</span></div><div className="location-actions"><button className="secondary small" disabled={busy} onClick={edit}>Edit problem</button><button className="remove-media" disabled={busy} onClick={remove}>Remove problem</button></div></div>
